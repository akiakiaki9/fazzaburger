        ...
        <div>
            ...
            <div className="pagename">
                <div className="pagename-blok">
                    <h1>КОНТАКТЫ</h1>
                    <div className="pagename-blok__container">
                        <Link href='/' className='pagename__p-1'>Главное</Link>
                        <p className='pagename__drop'>{'>'}</p>
                        <Link href='/contacts' className="pagename__p-2">Контакты</Link>
                    </div>
                </div>
            </div>
