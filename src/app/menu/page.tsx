                ...
                {isIOS && (
                    <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-6 mt-6">
                        ...
                        <ul className="text-yellow-700 space-y-2 text-sm">
                            <li>• Для быстрого просмотра нажмите <b>Открыть для просмотра</b></li>
                            <li>• Чтобы сохранить меню, нажмите <b>Скачать PDF</b></li>
                            <li>• После скачивания откройте файл в приложении <b>Файлы</b></li>
                            <li>• Чтобы вернуться на сайт, используйте кнопку <b>Назад</b> в браузере</li>
                        </ul>
                    </div>
                )}
            </div>
